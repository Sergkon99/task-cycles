...
describe('Урок 5.10 - Циклы', () => {
    ...
    describe('Тест цикла symbolsReplace', () => {
        ...
        it('Автозамена каждого третьего символа в строке "М"', () => {
            expect(symbolsReplace('М')).toBe('М');
        });

        it('Автозамена каждого третьего символа в пустой строке ', () => {
            expect(symbolsReplace('')).toBe('');
        });
    });
});
